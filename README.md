...
This is a fork of the [grid_map](https://github.com/ANYbotics/grid_map) library, with certain modifications to be used in my ESA Spaceship traversability project. 
## Overview
